...
## **Goal**: 
The goal is to create a new marketing strategy targeting key metrics extracted from data insights aimed to convert casual riders into annual members.


## **Business Task**: 
How do annual members and casual riders of use the company bikes differently?
