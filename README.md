...
## **Goal**: 
The goal is to create a new marketing strategy that incorporates key metrics that  extracted from the business dataset to convert casual riders into annual members.
