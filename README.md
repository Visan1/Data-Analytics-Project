...
## **Goal**: 
The goal is to create a new marketing strategy that incorporates key metrics extracted from dataset insights to convert casual riders into annual members.
