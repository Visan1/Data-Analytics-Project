...
## **Goal**: 
The goal is to create a new marketing strategy incorporating key metrics extracted from data insights aimed to convert casual riders into annual members.
